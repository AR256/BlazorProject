...
namespace BlazorProject.Infrastructure.Migrations
{
    ...
    [Migration("20241018184427_AddedModifiedAndCreatedDates")]
    partial class AddedModifiedAndCreatedDates
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BlazorProject.Domain.Entities.InvoiceType", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("BlazorProject.Domain.Entities.Invoice", b =>
                {
                    ...
                    b.HasOne("BlazorProject.Domain.Entities.InvoiceType", "NInvoiceType")
                        .WithMany("Invoices")
